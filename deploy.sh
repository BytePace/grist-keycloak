...
Use this configuration in your mobile app (Keycloak client '$GRIST_MOBILE_OIDC_CLIENT_ID', not grist-client):
...
grist-client with client secret is only for Grist server container; mobile app uses PKCE with client_id '$GRIST_MOBILE_OIDC_CLIENT_ID'.
